...
const dataset = gdal.open('C:/Work/MyProjects/open-source/r.avaflow/web-app/server/uploads/bs_elev.tif');
...
console.log(`Количество ячеек: ${totalCells} (${rasterWidth} x ${rasterHeight})`);
